...
| C3 | Backlight boost drives **4 parallel** LEDs from a 4.4 V node → overdrive, can't switch off | replace TPS61165 with a **buck WLED driver (AL8860)** from SYS_PWR_IN, PWM-dimmed |
