...
Machine-readable placement intent is generated by
`scripts/materialize_tropic01_universal_placement.py` into
`production/placement-plan.json`. That JSON is a pre-layout contract, not a
PCBWay position file.
