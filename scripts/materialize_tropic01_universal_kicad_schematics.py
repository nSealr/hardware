...
SHEET_NOTES = {
    ...
    "kicad/sheets/display_controls.kicad_sch": [
        "Display target: portrait Newhaven NHD-2.4-240320AF-CSXP-CTP, ST7789VI plus FT5426-003 touch.",
...
SYMBOLS = {
    ...
    "J2": SymbolSpec(
        ref="J2",
        value="Molex 54132-4062 TFT FFC",
        lib_id="Connector_Generic:Conn_01x40",
        footprint="Connector_FFC-FPC:Molex_54132-4062_1x40-1MP_P0.50mm_Horizontal",
        datasheet="https://newhavendisplay.com/content/specs/NHD-2.4-240320AF-CSXP-CTP.pdf",
        description="40-pin TFT FFC for Newhaven 2.4 inch touch display module",
    ...
    "J2B": SymbolSpec(
        ref="J2B",
        value="Molex 52271-0679 CTP FFC",
        lib_id="Connector_Generic:Conn_01x06",
        footprint="Connector_FFC-FPC:Molex_52271-0679_1x06-1MP_P1.00mm_Horizontal",
        datasheet="https://newhavendisplay.com/content/specs/NHD-2.4-240320AF-CSXP-CTP.pdf",
        description="6-pin capacitive touch FFC for Newhaven display module",
        sheet="kicad/sheets/display_controls.kicad_sch",
        x=144.78,
        y=69.85,
    ),
